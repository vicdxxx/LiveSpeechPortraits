...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # display
        self.parser.add_argument('--display_winsize', type=int, default=cfg.target_image_size[0], help='display window size')
        ...
        self.parser.add_argument('--loadSize', type=int, default=cfg.target_image_size[0], help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=cfg.target_image_size[0], help='then crop to this size')
        ...
        self.parser.add_argument('--resize_or_crop', type=str, default='scaleWidth',
                                 help='scaling and cropping of images at load time \
                                     [resize_and_crop|crop|scaledCrop|scaleWidth|scaleWidth_and_crop|scaleWidth_and_scaledCrop|\
                                         scaleHeight|scaleHeight_and_crop] etc')
