...
from options.base_options_audio2headpose import BaseOptions
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_final', type=float, default=1e-5, help='final learning rate for adam')
        parser.add_argument('--n_epochs_decay', type=int, default=250, help='number of epochs to linearly decay learning rate to lr_final')
